...
class AssociationTestCase(TestCase):
  def setUp(self):
    ...
    self.food_item_1 = FoodItem.objects.create(restaurant=self.restaurant)
    self.food_item_2 = FoodItem.objects.create(restaurant=self.restaurant)
    self.food_item_3 = FoodItem.objects.create(restaurant=self.restaurant)
    self.food_item_4 = FoodItem.objects.create(restaurant=self.restaurant)
